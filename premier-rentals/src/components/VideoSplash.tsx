...
export default function VideoSplash({ onComplete }: VideoSplashProps) {
  ...
  return (
    ...
    >
      {/* Blurred reflective background to fill the empty top/bottom space identically to the video's beige */}
      <video
        src={videoUrl}
        autoPlay
        muted
      ...
      <video
        ...
        playsInline
        onEnded={onComplete}
        className="absolute inset-0 h-full w-full object-contain pointer-events-none z-10 relative"
      />
